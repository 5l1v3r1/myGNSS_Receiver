...
void GNSSFlowgraph::init()
{
    ...
    std::cout << "@@@ sources_count= "<< sources_count_ << std::endl;
    std::cout << "@@@ configuration_= "<< configuration_ << std::endl;
    ...
    std::cout << "@@@ obs_implementation= "<< obs_implementation << std::endl;
    ...
    std::cout << "Blocks instantiated. " << channels_count_ << " channels."<<std::endl;
