                                ...
                                out_streams_(out_streams)
{
    ...
    std::string default_nmea_dump_filename = "./data/nmea_pvt.nmea";
    ...
    const std::string eph_default_xml_filename = "./data/gps_ephemeris.xml";
    const std::string utc_default_xml_filename = "./data/gps_utc_model.xml";
    const std::string iono_default_xml_filename = "./data/gps_iono.xml";
    const std::string ref_time_default_xml_filename = "./data/gps_ref_time.xml";
    const std::string ref_location_default_xml_filename = "./data/gps_ref_location.xml";
